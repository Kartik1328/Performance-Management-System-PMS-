  ...
  return (
    <>
      ...
      <div>
        ...
        >
          ...
          <textarea
            ...
            className="w-72 h-16 py-1 px-3 mt-3 ml-4 border rounded border-gray-300 text-gray-500"
            value="NA"
            readOnly
          />
          <textarea
            placeholder="Manager assessment"
            className="w-72 py-1 h-16 mt-3 px-3 ml-4 border rounded border-gray-300 text-gray-500"
            value="NA"
            readOnly
          />
          ...
          <textarea
            ...
            className="w-72 py-1 px-3 mt-3 h-16 ml-4 border rounded border-gray-300 text-gray-500"
            value=""
            readOnly
          />
      ...
      <div className="mb-64 -mt-12">
        ...
        <button
          style={{ marginLeft: "1%" }}
          className="mt-7 ml-2 py-2 px-5  bg-blue-400 text-white"
        ...
        <button
          style={{ marginLeft: "1%" }}
          className="mt-32 ml-2 py-2 px-7 bg-gray-300 text-white"
        >
          Cancel
        </button>
      </div>
