...
function AnnualReviewByMgr() {
  ...
  const handleSubmit = () => {
    Service.postByAnnRev().then((response) => {
      Service.getByAnnualById().then((response) =>
        setAnnRevValues(response.data)
      );
    });
  ...
  return (
    <div className="w-full h-screen bg-gray-200">
      <div className="bg-white rounded-md relative top-12 ml-4 mr-3 border-[1px] border-blue-400 pb-24">
        ...
        <div className="text-gray-400 pl-1">
          <div className="relative">
            ...
            <ul className="flex space-x-4  p-4">
              <li>
                <button className="text-lg">Goal Setting</button>
              </li>
              <li>
                <button className="text-lg">Self Assessment</button>
              </li>
              <li>
                <button className="text-lg">Manager Assessment</button>
              </li>
              <li>
                <button className="text-lg">Annual Review</button>
              </li>
            </ul>
          </div>
        </div>
        ...
        <h2 className="text-xl font-normal text-black pl-6 pt-6">
          Manager Feedback
        </h2>
            ...
            <div className="grid grid-cols-10 ml-5">
              <div className="col-span-2 mt-5 ">
                <div className="pl-4 text-gray-600 space-y-16 ml-2">
                  <h2 className={`text-lg pt-2 ${index !== 0 && "hidden"}`}>
                    Manager Rating
                  </h2>
                  <h2 className={`text-lg pt-1.5 ${index !== 0 && "hidden"}`}>
                    Manager Comment
                  </h2>
                  <h2
                    className={`text-lg pt-[320px] ${index !== 0 && "hidden"}`}
                  >
                    Area of imporvement
                  </h2>
                  <h2 className={`text-lg pt-16 ${index !== 0 && "hidden"}`}>
                    Strength
                  </h2>
                </div>
              ...
              <div className="col-span-6  mt-5  space-y-6 -ml-14">
                ...
                <textarea
                  ...
                  className=" placeholder-gray-400 overflow-hidden resize-none w-[23%] h-[60px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3"
                  value={annRevValues.ratings}
                />
                <textarea
                  type="text"
                  placeholder="Enter here"
                  className=" placeholder-gray-400 overflow-hidden resize-none w-[78%] h-[375px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3"
                  value={annRevValues.managerComment}
                />
                <textarea
                  type="text"
                  placeholder="Enter here"
                  className=" placeholder-gray-400 overflow-hidden resize-none w-[78%] h-[120px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3"
                  value={annRevValues.areaOfImprovement}
                />
                <textarea
                  type="text"
                  placeholder="Enter here"
                  className=" placeholder-gray-400 overflow-hidden resize-none w-[78%] h-[120px] font-extralight text-normal text-gray-600 -ml-0 pt-2 border-[1px] border-gray-300 p-1 mt-3"
                  value={annRevValues.appraiseeStrength}
                />
              </div>
        ...
        <div className="">
          <h2 className="text-xl font-normal text-black pl-6 pt-10">
            Employee Feedback
          </h2>
          <h2 className="text-lg font-normal text-gray-600 pl-6 pt-10 ml-5">
            Employee Comment
          </h2>
          <textarea
            type="text"
            placeholder=""
            className=" placeholder-gray-400 overflow-hidden resize-none w-[49%] h-[120px] font-extralight text-normal text-gray-600 ml-52 pt-2 border-[1px] border-gray-300 p-1 -mt-5 cursor-not-allowed outline-none"
            value={annRevValues.managerComment}
            readOnly
          />
        </div>
