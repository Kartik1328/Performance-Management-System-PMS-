...
// useEffect(() => {
//   axios.get('http://43.205.24.208:9031/api/getByEmployeeStatus')
...
// useEffect(()=>{
//   axios.get("http://43.205.24.208:9031/api/getBySelfAsm/10")
//   .then((response)=>{
...
// useEffect(()=>{
//   axios.get("http://43.205.24.208:9031/api/getByManagerAsm/20")
//   .then((response)=>{
