...
//    }
    public String sendRevertBackMail(EmployeeStatus employeeStatus) throws MessagingException {
        Map<String, Object> variables = new HashMap<>();
        variables.put("Name", "Amulya");
        variables.put("Comments", employeeStatus.getMgrRevertComments()); // Updated for EmployeeStatus
